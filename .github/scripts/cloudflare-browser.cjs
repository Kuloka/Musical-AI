...
(async()=>{
 ...
 try{
  for(const mobile of [false,true]){
   ...
   const response=await page.goto('https://multimind-ai.pages.dev/',{waitUntil:'domcontentloaded',timeout:60000});
  ...
  await page.goto('https://multimind-ai.pages.dev/',{waitUntil:'load',timeout:30000});
  await page.locator('h1').waitFor({state:'visible'});
