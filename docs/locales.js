...
en:{
 meta:['MultiMind — your models, your rhythm','A desktop AI workspace with local models, collaborative agents, MCP tools and Ollama Cloud. Download for Windows, macOS and Linux.'],
 nav:['Skip to content','Features','How it works','Download','Language'],
 hero:['YOUR SPACE FOR AI','Your models.','Your rhythm.','From the first thought to the finished result.','Local models, a team of agents and your tools — together in one app.','Download MultiMind','View on GitHub','Windows · macOS · Linux · No subscription required for local inference'],
 product:['MULTIMIND / WORKSPACE','Less noise. More room to think.','MultiMind desktop interface with projects and a chat composer','Local when you want independence.','Cloud when you need larger models.'],
 ...
 download:['READY FOR YOUR FIRST IDEA?','Your next step starts here.','Choose your system and install MultiMind.','Download for Windows','Download for macOS','Download for Linux','Installer','Portable','Apple Silicon','Intel Mac','Ubuntu / Debian','Version','On macOS and Linux, install Ollama for local models or connect Ollama Cloud. Windows also supports the built-in engine.','macOS builds are unsigned and not notarized by Apple.','All releases'],
 ...
 ['How do I install on Linux or Mac?','Linux: install the .deb on Ubuntu/Debian, or make the AppImage executable and run it (FUSE may be required). Mac: open the DMG and drag MultiMind to Applications. macOS may require approval in Privacy & Security for the unsigned app.'],
...
ru:{
 meta:['MultiMind — твои модели, твой ритм','AI-приложение с локальными моделями, сабагентами, MCP и Ollama Cloud. Скачать для Windows, macOS и Linux.'],
 nav:['К содержимому','Возможности','Как это работает','Скачать','Язык'],
 hero:['ТВОЁ ПРОСТРАНСТВО ДЛЯ AI','Твои модели.','Твой ритм.','От первой мысли до готового результата.','Локальные модели, команда агентов и инструменты — в одном приложении.','Скачать MultiMind','Смотреть на GitHub','Windows · macOS · Linux · Локальная генерация без подписки'],
 product:['MULTIMIND / РАБОЧЕЕ ПРОСТРАНСТВО','Меньше шума. Больше места для мысли.','Интерфейс MultiMind с проектами и полем запроса','Локально, когда важна автономность.','Облако, когда нужны более крупные модели.'],
 ...
 download:['ГОТОВ К ПЕРВОЙ ИДЕЕ?','Твой следующий шаг начинается здесь.','Выбери свою систему и установи MultiMind.','Скачать для Windows','Скачать для macOS','Скачать для Linux','Установщик','Без установки','Apple Silicon','Intel Mac','Ubuntu / Debian','Версия','На macOS и Linux установи Ollama для локальных моделей или подключи Ollama Cloud. На Windows также доступен встроенный движок.','Сборки macOS без подписи и нотариального заверения Apple.','Все релизы'],
 ...
 ['Как установить на Linux или Mac?','Linux: установи .deb на Ubuntu/Debian или разреши выполнение AppImage и запусти его (может понадобиться FUSE). Mac: открой DMG и перенеси MultiMind в «Программы». Для приложения без подписи может потребоваться разрешение в разделе «Конфиденциальность и безопасность».'],
